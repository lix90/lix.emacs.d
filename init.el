...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yafolding polymode monokai-theme google-translate doremi-cmd doremi-frm doremi sr-speedbar projectile project-explorer youdao-dictionary yaml-mode whole-line-or-region whitespace-cleanup-mode which-key weibo web-mode web-beautify web w3m use-package symon spaceline smartparens simple-httpd shell-pop scss-mode rvm robe rainbow-mode rainbow-delimiters py-autopep8 pug-mode psysh php-eldoc phi-rectangle paradox osx-dictionary origami neotree multiple-cursors move-text moe-theme mmm-mode matlab-mode markdown-toc magithub magit-gitflow lorem-ipsum latex-preview-pane json-mode js2-mode js-comint hungry-delete hexo golden-ratio flycheck flx fix-word expand-region exec-path-from-shell evil-nerd-commenter evil-magit evil-leader esup ess emmet-mode elpy disaster dired-details dash-functional dash-at-point crux counsel company-web company-statistics company-php company-emoji company-emacs-eclim company-auctex company-anaconda clang-format blog-admin bing-dict better-defaults benchmark-init auto-package-update aggressive-indent ace-jump-mode ac-php))))
(custom-set-faces
